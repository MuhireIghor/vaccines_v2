...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between gap-3 px-4 py-3">
      <UInput color="sky" v-model="search" icon="i-heroicons-magnifying-glass-20-solid" placeholder="Search User..." />

      <USelectMenu color="sky" v-model="selectedStatus" :options="todoStatus" multiple placeholder="Status" class="w-40" />
    </div>
